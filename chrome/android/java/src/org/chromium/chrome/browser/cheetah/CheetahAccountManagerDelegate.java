...
/**
 * CheetahAccountManagerDelegate
 */

public class CheetahAccountManagerDelegate implements AccountManagerDelegate {
    ...
    public CheetahAccountManagerDelegate() {
    ...
    public Account[] getAccountsSync() throws AccountManagerDelegateException {
        if(mAccount!=null) {
            return new Account[] {mAccount.getAccount()};
        } else {
            return new Account[] {};
        }
    }
    ...
    public String getAuthToken(Account account, String authTokenScope) throws AuthException {
        ...
        if(mAccount==null) {
            throw new AuthException(AuthException.NONTRANSIENT,
                    "Error while getting token for scope '" + authTokenScope + "'", new RuntimeException());
        }

        return mAccount.getServerAuthCode();
