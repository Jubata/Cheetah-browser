...
public class CommentsBottomSheetContent implements BottomSheet.BottomSheetContent,
    ...
    public CommentsBottomSheetContent(final ChromeActivity activity, final BottomSheet sheet,
        ...
        mSuggestionsUiDelegate = new SuggestionsUiDelegateImpl(
                new CommentsSource(profile, mSheet.getActiveTab()), depsFactory.createEventReporter(),
